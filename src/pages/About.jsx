    ...
    return (
      <div className="about pageSection" id="about">
        <div className="pageContainer">
          <h2 className="aboutTitle pageTitle">About me</h2>
            ...
            <div className="aboutRight">
              <div className="aboutRightContain">
                ...
                <h3 className="aboutRightFirst">
                  My name is César Iván Torres, I am a FrontEnd Developer, passionate about technology and Web Development. {" "}
                </h3>
                <p className="aboutRightText">
                  I have knowledge in web page construction, in addition, I have FrontEnd - React programming skills. I have the ability to adapt and self-taught with the desire to continue learning more.
                </p>
                <a
                  className="download"
